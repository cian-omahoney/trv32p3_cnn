...
if {[info exists env(ASIP_FLOW)]} {
  lappend search_path ./rm_setup ./rm_fc_scripts ./rm_tech_scripts ./rm_user_plugin_scripts
  lappend search_path {*}${ADDITIONAL_SEARCH_PATH}
  lappend search_path .
  if {[file exists [which $ADDITIONAL_FC_SETUP] ]} {
    source -echo $ADDITIONAL_FC_SETUP
  }
} else {
  set search_path [list ./rm_setup ./rm_fc_scripts ./rm_tech_scripts ./rm_user_plugin_scripts]
  lappend search_path .
