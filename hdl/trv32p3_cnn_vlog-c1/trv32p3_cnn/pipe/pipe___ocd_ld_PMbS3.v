...
module pipe___ocd_ld_PMbS3
  ...
  reg pipe_val___ocd_ld_PMbS3_r_out_next;
  reg pipe_we___ocd_ld_PMbS3_r_out;
  ...
  begin : p_pipe___ocd_ld_PMbS3
    pipe_val___ocd_ld_PMbS3_r_out_next = 0;
    pipe_we___ocd_ld_PMbS3_r_out = 1'h0;

    // (_pipe__ocd_ld_PMbEX_S3)
    pipe_we___ocd_ld_PMbS3_r_out = 1'b1;
    pipe_val___ocd_ld_PMbS3_r_out_next = __ocd_ld_PMbEX_w_in;

  end

  always @ (posedge clock)
  begin : clck_p_pipe___ocd_ld_PMbS3
    if (pipe_we___ocd_ld_PMbS3_r_out)
    begin
      pipe_val___ocd_ld_PMbS3_r_out <= pipe_val___ocd_ld_PMbS3_r_out_next;
    end
  end
endmodule
