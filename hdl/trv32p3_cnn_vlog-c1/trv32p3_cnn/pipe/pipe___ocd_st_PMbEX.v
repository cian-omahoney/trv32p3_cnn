...
module pipe___ocd_st_PMbEX
  ...
  reg pipe_val___ocd_st_PMbEX_r_out_next;
  reg pipe_we___ocd_st_PMbEX_r_out;
  ...
  begin : p_pipe___ocd_st_PMbEX
    pipe_val___ocd_st_PMbEX_r_out_next = 0;
    pipe_we___ocd_st_PMbEX_r_out = 1'h0;

    // (_pipe__ocd_st_PMbID_EX)
    pipe_we___ocd_st_PMbEX_r_out = 1'b1;
    pipe_val___ocd_st_PMbEX_r_out_next = __ocd_st_PMbID_w_in;

  end

  always @ (posedge clock)
  begin : clck_p_pipe___ocd_st_PMbEX
    if (pipe_we___ocd_st_PMbEX_r_out)
    begin
      pipe_val___ocd_st_PMbEX_r_out <= pipe_val___ocd_st_PMbEX_r_out_next;
    end
  end
endmodule
