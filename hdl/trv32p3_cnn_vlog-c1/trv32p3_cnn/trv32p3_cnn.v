...
module trv32p3_cnn
  ...
  assign dbg_reset_out = dbg_reset;
  ...
  // expanded mux_ocd_data_w
  // (ocd_data_w_copy0_dmb_rd___ocd_ld_DMbS3_r_S3_alw)
  // [ocd.n:73]
  assign ocd_data_w = dmb_rd_dp;

  // expanded mux_ocd_instr_w
  // (ocd_instr_w_copy0_pm_rd___ocd_ld_PMbS3_r_S3_alw)
  // [ocd.n:89]
  assign ocd_instr_w = pm_rd_dp;
  ...
  // expanded mux___X_x_r1_raddr
  // (__X_x_r1_raddr_cp___CTt5u_cstP15_EX_EX)
  // [alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:26](regX.n:75)(regX.n:121)
  assign __X_x_r1_raddr = reg_IR_EX[19:15];

  // expanded mux___X_x_r2_raddr
  // (__X_x_r2_raddr_cp___CTt5u_cstP20_EX_EX)
  // [alu.n:70][mpy.n:62][div.n:59][ldst.n:99][ldst.n:100][ldst.n:101][ctrl.n:95][cnn.n:27](regX.n:82)(regX.n:114)
  assign __X_x_r2_raddr = reg_IR_EX[24:20];

  // expanded mux___X_x_w2_waddr
  // (__X_x_w2_waddr_cp___CTt5u_cstP7_EX_EX)
  // [cnn.n:36](regX.n:107)
  assign __X_x_w2_waddr = reg_IR_EX[11:7];
  ...
  controller inst_controller(
      ...
      .bin_selector_ID(ID_enabling[1:0]),
      .cnd_in(cnd),
  ...
  mem_DMb inst_mem_DMb(
      .bin_selector_ID(ID_enabling[5:3]),
      .__ocd_ld_DMbEX_r_in(__ocd_ld_DMbEX_r),
      .__ocd_st_DMbEX_r_in(__ocd_st_DMbEX_r),
  ...
  mux_x_w1 inst_mux_x_w1(
      .bin_selector_EX(EX_enabling[21:18]),
  ...
  mux_x_w1_dead inst_mux_x_w1_dead(
      .bin_selector_EX(EX_enabling[22]),
      .cnn_R_in(cnn_R),
      .x_w1_in(x_w1),
      .x_w1_dead_out(x_w1_dead));

  mux_aluA inst_mux_aluA(
      .bin_selector_EX(EX_enabling[23]),
      .PC_EX_r_in(PC_EX_r),
      .x_r1_in(x_r1),
      .aluA_out(aluA));

  mux_aluB inst_mux_aluB(
      .bin_selector_EX(EX_enabling[25:24]),
  ...
  mux_pcaB inst_mux_pcaB(
      .bin_selector_ID(ID_enabling[9:8]),
  ...
  mux___X_x_w1_wad inst_mux___X_x_w1_wad(
      .ohe_selector_EX(EX_enabling[29]),
  ...
  mux___X_x_r3_raddr inst_mux___X_x_r3_raddr(
      .ohe_selector_EX(EX_enabling[30]),
      .ohe_selector_ID(ID_enabling[14]),
      .__CTt5u_cstP15_ID_in(reg_IR_ID[19:15]),
      .__CTt5u_cstP7_EX_in(reg_IR_EX[11:7]),
      .__X_x_r3_rad_out(__X_x_r3_raddr));

  hazards inst_hazards(
      .hazards_decode_ID(ID_enabling[22:15]),
      .hazards_decode_EX(EX_enabling[31]),
