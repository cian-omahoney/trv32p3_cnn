...
module hazards
  ...
  reg cmp_Ch_t5u_EX_11_7_eq_Ch_t5u_ID_19_15;
  reg cmp_Ch_t5u_ID_11_7_eq_div_adr_in;
  reg cmp_Ch_t5u_ID_19_15_eq_div_adr_in;
  reg cmp_Ch_t5u_ID_24_20_eq_div_adr_in;
  ...
  begin : p_hazards
    ...
    cmp_Ch_t5u_EX_11_7_eq_Ch_t5u_ID_19_15 = Ch_t5u_EX_11_7 == Ch_t5u_ID_19_15;
    cmp_Ch_t5u_ID_11_7_eq_div_adr_in = Ch_t5u_ID_11_7 == div_adr_in;
    cmp_Ch_t5u_ID_19_15_eq_div_adr_in = Ch_t5u_ID_19_15 == div_adr_in;
    cmp_Ch_t5u_ID_24_20_eq_div_adr_in = Ch_t5u_ID_24_20 == div_adr_in;

    if (                     // jalr_readHWraw1stEX and jalr_readHWraw2ndID
         (hazards_decode_EX && hazards_decode_ID[0] && cmp_Ch_t5u_EX_11_7_eq_Ch_t5u_ID_19_15))
      jalr_readHWraw = 1'b1; // ctrl.n:262
    else
      jalr_readHWraw = 1'b0;

    if (                          // read_after_divHWraw1stEX and read_after_divHWraw2ndID
         (div_bsy_in && hazards_decode_ID[1] && cmp_Ch_t5u_ID_19_15_eq_div_adr_in))
      read_after_divHWraw = 1'b1; // div.n:93
    else
      read_after_divHWraw = 1'b0;

    if (                            // read_after_div_1HWraw1stEX and read_after_div_1HWraw2ndID
         (div_bsy_in && hazards_decode_ID[2] && cmp_Ch_t5u_ID_19_15_eq_div_adr_in)
                                    // read_after_div_1HWraw1stEX and read_after_div_1HWraw2nd1ID
      || (div_bsy_in && hazards_decode_ID[3] && cmp_Ch_t5u_ID_24_20_eq_div_adr_in)
                                    // read_after_div_1HWraw1stEX and read_after_div_1HWraw2nd2ID
      || (div_bsy_in && hazards_decode_ID[4] && cmp_Ch_t5u_ID_11_7_eq_div_adr_in))
      read_after_div_1HWraw = 1'b1; // div.n:93
    else
      read_after_div_1HWraw = 1'b0;

    if (                           // write_after_divHWwaw1stEX and write_after_divHWwaw2ndID
         (div_bsy_in && hazards_decode_ID[5] && cmp_Ch_t5u_ID_11_7_eq_div_adr_in))
    ...
    if (                                // agu_read_after_writeHWraw1stEX and agu_read_after_writeHWraw2ndID
         (hazards_decode_EX && hazards_decode_ID[1] && cmp_Ch_t5u_EX_11_7_eq_Ch_t5u_ID_19_15))
