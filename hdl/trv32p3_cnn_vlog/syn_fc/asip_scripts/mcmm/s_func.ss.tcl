...
#set_clock_latency -early 0.50 [get_clocks ${CLK_NAME}]
#set_clock_latency -late  0.55 [get_clocks ${CLK_NAME}]
#set_clock_latency -min 0.50 [get_clocks ${CLK_NAME}]
#set_clock_latency -max 0.55 [get_clocks ${CLK_NAME}]
