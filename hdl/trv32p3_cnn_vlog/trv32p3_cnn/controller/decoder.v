...
module decoder
  ...
  begin : decode_ID
    ...
    begin
      ...
      begin
        en_hazards_decode_ID[2] = 1'b1; // read_after_div_1HWraw2ndID  t5u_cstP15_EX[alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:33][cnn.n:53]
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
  ...
  begin : decode_EX
    ...
    begin
      ...
      begin
        ...
        __X_x_r1_raddr_EX = reg_IR_ID[19:15]; // __X_x_r1_raddr_cp___CTt5u_cstP15_EX_EX [alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:33][cnn.n:53](regX.n:77)(regX.n:123)
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
        || ( reg_IR_ID[31] == 1'b0 && reg_IR_ID[29:25] == 5'b00000 && reg_IR_ID[14:12] == 3'b000 && reg_IR_ID[6:5] == 2'b01 && reg_IR_ID[3:0] == 4'b0011) // 0x00000xxxxxxxxxx000xxxxx01x0011
      ...
      begin
        ...
        en_cnn_bin_sel_EX = 2'b10;           // cnn_R_mac_xuC_xuA_xuB_cnn_EX [cnn.n:39]
      end
      if (
