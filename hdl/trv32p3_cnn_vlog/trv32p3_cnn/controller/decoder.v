...
// File generated by Go version U-2022.12#33f3808fcb#221128, Tue Mar 19 17:30:42 2024
...
module decoder
  ...
  reg    [35:0] EX_enabling;
  wire   [23:0] ID_enabling;
  wire   internal_mc_stall;
  wire   new_mc_reg_val;
  reg    [35:0] predec_EX_enabling;
  ...
  begin : decode_ID
    ...
    begin
      ...
      begin
        en_hazards_decode_ID[2] = 1'b1; // read_after_div_1HWraw2ndID  t5u_cstP15_EX[alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:32][cnn.n:52]
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
      ...
      begin
        en_hazards_decode_ID[3] = 1'b1; // read_after_div_1HWraw2nd1ID  t5u_cstP20_EX[alu.n:70][mpy.n:62][div.n:59][ldst.n:99][ldst.n:100][ldst.n:101][ctrl.n:95][cnn.n:33]
      end
      if (
           ( reg_IR_ID[31:25] == 7'b1100000 && reg_IR_ID[14:12] == 3'b001 && reg_IR_ID[6:0] == 7'b0110011) // 1100000xxxxxxxxxx001xxxxx0110011
         )
      begin
        en_hazards_decode_ID[4] = 1'b1; // read_after_div_1HWraw2nd2ID  t5u_cstP7_EX[cnn.n:34]
      end
      if (
      ...
      begin
        en_hazards_decode_ID[5] = 1'b1; // write_after_divHWwaw2ndID  t5u_cstP7_EX[regX.n:101][cnn.n:42]
      end
      if (
  ...
  begin : decode_EX
    ...
    begin
      ...
      begin
        ...
        en_cnn_bin_sel_EX = 2'b10;           // cnn_R_mac_xuC_xuA_xuB_cnn_EX [cnn.n:38]
      end
      if (
      ...
      begin
        en_mux_x_w1_bin_sel_EX = 3'b101; // x_w1_copy0_cnn_w1_EX [cnn.n:58](regX.n:98)
      end
      if (
           ( reg_IR_ID[14] == 1'b0 && reg_IR_ID[12] == 1'b0 && reg_IR_ID[6:0] == 7'b0000011) // xxxxxxxxxxxxxxxxx0x0xxxxx0000011
        || ( reg_IR_ID[13] == 1'b0 && reg_IR_ID[6:0] == 7'b0000011)                          // xxxxxxxxxxxxxxxxxx0xxxxxx0000011
      ...
      begin
        en_hazards_decode_EX = 1'b1; // jalr_readHWraw1stEX  t5u_cstP7_EX[regX.n:101][cnn.n:42]
    ...
    predec_EX_enabling[35] = en_hazards_decode_EX;
  end
