...
module decoder
  ...
  begin : decode_ID
    ...
    begin
      ...
      begin
        en_hazards_decode_ID[2] = 1'b1; // read_after_div_1HWraw2ndID  t5u_cstP15_EX[alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:33]
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
      ...
      begin
        en_hazards_decode_ID[3] = 1'b1; // read_after_div_1HWraw2nd1ID  t5u_cstP20_EX[alu.n:70][mpy.n:62][div.n:59][ldst.n:99][ldst.n:100][ldst.n:101][ctrl.n:95][cnn.n:34]
      end
      if (
           ( reg_IR_ID[31:25] == 7'b1100000 && reg_IR_ID[14:12] == 3'b001 && reg_IR_ID[6:0] == 7'b0110011) // 1100000xxxxxxxxxx001xxxxx0110011
         )
      begin
        en_hazards_decode_ID[4] = 1'b1; // read_after_div_1HWraw2nd2ID  t5u_cstP7_EX[cnn.n:35]
      end
      if (
      ...
      begin
        en_hazards_decode_ID[5] = 1'b1; // write_after_divHWwaw2ndID  t5u_cstP7_EX[regX.n:101][cnn.n:43]
      end
      if (
  ...
  begin : decode_EX
    ...
    begin
      ...
      begin
        ...
        __X_x_r1_raddr_EX = reg_IR_ID[19:15]; // __X_x_r1_raddr_cp___CTt5u_cstP15_EX_EX [alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:33](regX.n:77)(regX.n:123)
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
        || ( reg_IR_ID[31] == 1'b0 && reg_IR_ID[29:25] == 5'b00000 && reg_IR_ID[14:12] == 3'b000 && reg_IR_ID[6:5] == 2'b01 && reg_IR_ID[3:0] == 4'b0011) // 0x00000xxxxxxxxxx000xxxxx01x0011
      ...
      begin
        ...
        __X_x_r2_raddr_EX = reg_IR_ID[24:20]; // __X_x_r2_raddr_cp___CTt5u_cstP20_EX_EX [alu.n:70][mpy.n:62][div.n:59][ldst.n:99][ldst.n:100][ldst.n:101][ctrl.n:95][cnn.n:34](regX.n:84)(regX.n:116)
      end
      if (
           ( reg_IR_ID[31:25] == 7'b1100000 && reg_IR_ID[14:12] == 3'b001 && reg_IR_ID[6:0] == 7'b0110011) // 1100000xxxxxxxxxx001xxxxx0110011
         )
      begin
        ...
        __X_x_r3_raddr_EX = reg_IR_ID[11:7]; // __X_x_r3_raddr_cp___CTt5u_cstP7_EX_EX [cnn.n:35](regX.n:109)
        en_cnn_ohe_sel_EX = 1'b1;            // cnn_R_mac_xuC_xuA_xuB_cnn_EX [cnn.n:39]
      end
      if (
      ...
      begin
        ...
        __X_x_w2_waddr_EX = reg_IR_ID[11:7]; // __X_x_w2_waddr_cp___CTt5u_cstP7_EX_EX [cnn.n:43](regX.n:109)
        en_reg_X_bin_sel_EX = 2'b10;         // X_wr_x_w2___X_x_w2_wad_EX [cnn.n:43](regX.n:109)
      end
      if (
      ...
      begin
        en_hazards_decode_EX = 1'b1; // jalr_readHWraw1stEX  t5u_cstP7_EX[regX.n:101][cnn.n:43]
                                     // agu_read_after_writeHWraw1stEX  t5u_cstP7_EX[regX.n:101][cnn.n:43]
      end
    end
