...
module decoder
  ( input         reset,
    ...
    output [40:0] EX_enabling_out,
    output [30:0] ID_enabling_out,
  ...
  reg    [40:0] EX_enabling;
  wire   [30:0] ID_enabling;
  wire   internal_mc_stall;
  wire   new_mc_reg_val;
  reg    [40:0] predec_EX_enabling;
  reg    [30:0] predec_ID_enabling;
  reg    reg_ID_valid;
  reg    [31:0] reg_IR_EX;
  reg    [31:0] reg_IR_ID;
  wire   trn_EX_valid;
  ...
  begin : decode_ID
    ...
    begin
      ...
      begin
        en_agu_ohe_sel_ID = 1'b1; // aguR_add_aguA_aguB_agu_ID [ldst.n:57][ldst.n:94][cnn.n:100]
      end
      if (
           ( reg_IR_ID[31:0] == 32'b11000000000000000111000000110011) // 11000000000000000111000000110011
         )
      begin
        en_agu2_ohe_sel_ID = 1'b1;         // aguR2_add_aguA2_aguB2_agu2_ID [cnn.n:120]
        en_reg_X_ohe_sel_ID = 1'b1;        // X10_wr_x_w2_ID [cnn.n:98]
                                           // X11_wr_x_w5_ID [cnn.n:117]
                                           // X13_wr_x_w3_ID [cnn.n:101]
                                           // X14_wr_x_w6_ID [cnn.n:121]
        en_mem_DMb_ohe_sel_ID = 1'b1;      // mem_enab_dmw_rd2_ld_DMw_dm_addr2_ID [cnn.n:125]
                                           // cp_extad_dmw_rd2_ld_DMw_dm_addr2_ID [cnn.n:125]
        en_mux_dm_addr_bin_sel_ID = 2'b01; // dm_addr_copy0_aguA_ID [cnn.n:102]
        en_mux_x_w2_ohe_sel_ID = 1'b1;     // x_w2_copy0_x_r5_ID [cnn.n:98]
        en_mux_aguA_ohe_sel_ID = 1'b1;     // aguA_copy0_x_r4_ID [cnn.n:96]
        en_hazards_decode_ID[2] = 1'b1;    // read_after_divHWraw2nd1ID [cnn.n:96][cnn.n:98][cnn.n:115][cnn.n:117]
                                           // read_after_divHWraw2nd2ID [cnn.n:96][cnn.n:98][cnn.n:115][cnn.n:117]
                                           // read_after_divHWraw2nd3ID [cnn.n:96][cnn.n:98][cnn.n:115][cnn.n:117]
                                           // read_after_divHWraw2nd4ID [cnn.n:96][cnn.n:98][cnn.n:115][cnn.n:117]
                                           // read_after_div_1HWraw2nd3ID [cnn.n:76][cnn.n:77][cnn.n:78]
                                           // read_after_div_1HWraw2nd4ID [cnn.n:76][cnn.n:77][cnn.n:78]
                                           // read_after_div_1HWraw2nd5ID [cnn.n:76][cnn.n:77][cnn.n:78]
                                           // write_after_divHWwaw2ndID [cnn.n:98][cnn.n:101][cnn.n:117][cnn.n:121]
                                           // write_after_divHWwaw2nd1ID [cnn.n:98][cnn.n:101][cnn.n:117][cnn.n:121]
                                           // write_after_divHWwaw2nd2ID [cnn.n:98][cnn.n:101][cnn.n:117][cnn.n:121]
                                           // write_after_divHWwaw2nd3ID [cnn.n:98][cnn.n:101][cnn.n:117][cnn.n:121]
                                           // write_after_div_1HWwaw2nd1ID [cnn.n:81][cnn.n:107][cnn.n:129]
                                           // write_after_div_1HWwaw2nd2ID [cnn.n:81][cnn.n:107][cnn.n:129]
                                           // write_after_div_1HWwaw2nd3ID [cnn.n:81][cnn.n:107][cnn.n:129]
      end
      if (
           ( reg_IR_ID[6:0] == 7'b1101111) // xxxxxxxxxxxxxxxxxxxxxxxxx1101111
         )
      ...
      begin
        en_mem_DMb_bin_sel_ID = 3'b001; // mem_enab_dmw_rd_ld_DMw_dm_addr_ID [ldst.n:64][cnn.n:105]
                                        // cp_extad_dmw_rd_ld_DMw_dm_addr_ID [ldst.n:64][cnn.n:105]
      end
      if (
           ( reg_IR_ID[14:12] == 3'b000 && reg_IR_ID[6:0] == 7'b0100011) // xxxxxxxxxxxxxxxxx000xxxxx0100011
         )
      begin
        en_mem_DMb_bin_sel_ID = 3'b010; // mem_enab_DMb_st_dmb_wr_dm_addr_ID [ldst.n:99]
      ...
      begin
        en_mem_DMb_bin_sel_ID = 3'b011; // mem_enab_DMh_st_dmh_wr_dm_addr_ID [ldst.n:100]
      ...
      begin
        en_mem_DMb_bin_sel_ID = 3'b100; // mem_enab_DMw_st_dmw_wr_dm_addr_ID [ldst.n:101]
      ...
      begin
        en_mem_DMb_bin_sel_ID = 3'b101; // mem_enab_dmb_rd_ld_DMb_dm_addr_ID [ldst.n:62]
      ...
      begin
        en_mem_DMb_bin_sel_ID = 3'b110; // mem_enab_dmh_rd_ld_DMh_dm_addr_ID [ldst.n:63]
      ...
      begin
        en_mux_dm_addr_bin_sel_ID = 2'b10; // dm_addr_copy0_aguR_ID [ldst.n:58][ldst.n:95]
      end
      if (
           ( reg_IR_ID[14] == 1'b1 && reg_IR_ID[6:0] == 7'b1100011) // xxxxxxxxxxxxxxxxx1xxxxxxx1100011
        || ( reg_IR_ID[13] == 1'b0 && reg_IR_ID[6:0] == 7'b1100011) // xxxxxxxxxxxxxxxxxx0xxxxxx1100011
      ...
      begin
        en_hazards_decode_ID[3] = 1'b1; // read_after_div_1HWraw2ndID  t5u_cstP15_EX[alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:32][cnn.n:52]
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
      ...
      begin
        en_hazards_decode_ID[4] = 1'b1; // read_after_div_1HWraw2nd1ID  t5u_cstP20_EX[alu.n:70][mpy.n:62][div.n:59][ldst.n:99][ldst.n:100][ldst.n:101][ctrl.n:95][cnn.n:33]
      end
      if (
           ( reg_IR_ID[31:25] == 7'b1100000 && reg_IR_ID[14:12] == 3'b001 && reg_IR_ID[6:0] == 7'b0110011) // 1100000xxxxxxxxxx001xxxxx0110011
         )
      begin
        en_hazards_decode_ID[5] = 1'b1; // read_after_div_1HWraw2nd2ID  t5u_cstP7_EX[cnn.n:34]
      end
      if (
      ...
      begin
        en_hazards_decode_ID[6] = 1'b1; // write_after_div_1HWwaw2ndID  t5u_cstP7_EX[regX.n:101][cnn.n:42]
      end
      if (
           ( reg_IR_ID[31:25] == 7'b0000001 && reg_IR_ID[14] == 1'b1 && reg_IR_ID[6:0] == 7'b0110011) // 0000001xxxxxxxxxx1xxxxxxx0110011
         )
      begin
        en_hazards_decode_ID[7] = 1'b1; // div_busyHWnoDep2ndID
      end
      if (
        ...
        || ( reg_IR_ID[31:6] == 26'b11000000000000000111000000 && reg_IR_ID[4:3] == 2'b10 && reg_IR_ID[1:0] == 2'b11)                                                                   // 11000000000000000111000000x10x11
        || ( reg_IR_ID[31:20] == 12'b110000000000 && reg_IR_ID[14:11] == 4'b0111 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:3] == 2'b10 && reg_IR_ID[1:0] == 2'b11)                         // 110000000000xxxxx0111xxxx0x10x11
        || ( reg_IR_ID[31:20] == 12'b110000000000 && reg_IR_ID[14:12] == 3'b011 && reg_IR_ID[10] == 1'b1 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:3] == 2'b10 && reg_IR_ID[1:0] == 2'b11) // 110000000000xxxxx011x1xxx0x10x11
        || ( reg_IR_ID[31:20] == 12'b110000000000 && reg_IR_ID[14:12] == 3'b011 && reg_IR_ID[9] == 1'b1 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:3] == 2'b10 && reg_IR_ID[1:0] == 2'b11)  // 110000000000xxxxx011xx1xx0x10x11
        || ( reg_IR_ID[31:20] == 12'b110000000000 && reg_IR_ID[14:12] == 3'b011 && reg_IR_ID[8] == 1'b1 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:3] == 2'b10 && reg_IR_ID[1:0] == 2'b11)  // 110000000000xxxxx011xxx1x0x10x11
      ...
      begin
        en_hazards_decode_ID[8] = 1'b1; // div_wpHWnoDep2ndID
      end
    end
    if (hzd_stall_in)
    begin
    ...
    predec_ID_enabling[2] = en_agu2_ohe_sel_ID;
    predec_ID_enabling[4:3] = en_controller_bin_sel_ID;
    predec_ID_enabling[5] = en_reg_PC_EX_ohe_sel_ID;
    predec_ID_enabling[6] = en_reg_X_ohe_sel_ID;
    predec_ID_enabling[7] = en_mem_DMb_ohe_sel_ID;
    predec_ID_enabling[10:8] = en_mem_DMb_bin_sel_ID;
    predec_ID_enabling[12:11] = en_mux_dm_addr_bin_sel_ID;
    predec_ID_enabling[13] = en_mux_x_w2_ohe_sel_ID;
    predec_ID_enabling[14] = en_mux_pcaA_ohe_sel_ID;
    predec_ID_enabling[16:15] = en_mux_pcaB_bin_sel_ID;
    predec_ID_enabling[17] = en_mux_jmp_tgt_ID_ohe_sel_ID;
    predec_ID_enabling[18] = en_mux_aguA_ohe_sel_ID;
    predec_ID_enabling[20:19] = en_mux_aguB_bin_sel_ID;
    predec_ID_enabling[21] = en_mux___pidTGT_w_ohe_sel_ID;
    predec_ID_enabling[30:22] = en_hazards_decode_ID;
  end
  ...
  begin : decode_EX
    ...
    reg en_lx2_ohe_sel_EX;
    reg en_controller_ohe_sel_EX;
    reg en_reg_X_ohe_sel_EX;
    reg [1:0] en_reg_X_bin_sel_EX;
    reg en_mem_DMb_ohe_sel_EX;
    ...
    reg [1:0] en_mux___X_x_w1_wad_bin_sel_EX;
    ...
    en_reg_X_ohe_sel_EX = 0;
    en_reg_X_bin_sel_EX = 0;
    en_mem_DMb_ohe_sel_EX = 0;
    ...
    en_mux___X_x_w1_wad_bin_sel_EX = 0;
    ...
    begin
      ...
      begin
        ...
        __X_x_r1_raddr_EX = reg_IR_ID[19:15]; // __X_x_r1_raddr_cp___CTt5u_cstP15_EX_EX [alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:32][cnn.n:52](regX.n:77)(regX.n:123)
      end
      if (
           ( reg_IR_ID[31:0] == 32'b11000000000000000111000000110011) // 11000000000000000111000000110011
         )
      begin
        en___X_x_r1_raddr_EX = 1'b1;
        __X_x_r1_raddr_EX = 10;                 // __X_x_r1_raddr_cp_cst_addr10_off10_EX [cnn.n:76]
        en___X_x_r2_raddr_EX = 1'b1;
        __X_x_r2_raddr_EX = 11;                 // __X_x_r2_raddr_cp_cst_addr11_off11_EX [cnn.n:77]
        en___X_x_r3_raddr_EX = 1'b1;
        __X_x_r3_raddr_EX = 12;                 // __X_x_r3_raddr_cp_cst_addr12_off12_EX [cnn.n:78]
        en_lx2_ohe_sel_EX = 1'b1;               // lxR2_copy0_dmw_rd2_lx2_EX [cnn.n:127]
        en_reg_X_ohe_sel_EX = 1'b1;             // X15_wr_x_w4_EX [cnn.n:107]
                                                // X16_wr_x_w7_EX [cnn.n:129]
        en_mem_DMb_bin_sel_EX = 3'b101;         // cp_extin_dmw_rd2_ld_DMw_dm_addr2_ID [cnn.n:125]
        en_mux___X_x_w1_wad_bin_sel_EX = 2'b10; // cp_addr_X12_wr_x_w1_EX [cnn.n:81]
        en_hazards_decode_EX[1] = 1'b1;         // jalr_readHWraw1st1EX [cnn.n:81][cnn.n:107][cnn.n:129]
                                                // jalr_readHWraw1st2EX [cnn.n:81][cnn.n:107][cnn.n:129]
                                                // jalr_readHWraw1st3EX [cnn.n:81][cnn.n:107][cnn.n:129]
                                                // agu_read_after_writeHWraw1st1EX [cnn.n:81][cnn.n:107][cnn.n:129]
                                                // agu_read_after_writeHWraw1st2EX [cnn.n:81][cnn.n:107][cnn.n:129]
                                                // agu_read_after_writeHWraw1st3EX [cnn.n:81][cnn.n:107][cnn.n:129]
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
        || ( reg_IR_ID[31] == 1'b0 && reg_IR_ID[29:25] == 5'b00000 && reg_IR_ID[14:12] == 3'b000 && reg_IR_ID[6:5] == 2'b01 && reg_IR_ID[3:0] == 4'b0011) // 0x00000xxxxxxxxxx000xxxxx01x0011
      ...
      begin
        en___X_x_r2_raddr_EX = 1'b1;
        __X_x_r2_raddr_EX = reg_IR_ID[24:20]; // __X_x_r2_raddr_cp___CTt5u_cstP20_EX_EX [alu.n:70][mpy.n:62][div.n:59][ldst.n:99][ldst.n:100][ldst.n:101][ctrl.n:95][cnn.n:33](regX.n:84)(regX.n:116)
      end
      if (
           ( reg_IR_ID[31:25] == 7'b1100000 && reg_IR_ID[14:12] == 3'b001 && reg_IR_ID[6:0] == 7'b0110011) // 1100000xxxxxxxxxx001xxxxx0110011
         )
      begin
        en___X_x_r3_raddr_EX = 1'b1;
        __X_x_r3_raddr_EX = reg_IR_ID[11:7]; // __X_x_r3_raddr_cp___CTt5u_cstP7_EX_EX [cnn.n:34](regX.n:109)
      end
      if (
      ...
      begin
        ...
        __X_x_w2_waddr_EX = reg_IR_ID[11:7]; // __X_x_w2_waddr_cp___CTt5u_cstP7_EX_EX [cnn.n:42](regX.n:109)
        en_reg_X_bin_sel_EX = 2'b10;         // X_wr_x_w2___X_x_w2_wad_EX [cnn.n:42](regX.n:109)
      end
      if (
      ...
      begin
        en_lx_bin_sel_EX = 3'b001;    // lxR_copy0_dmw_rd_lx_EX [ldst.n:72][cnn.n:106]
        en_mem_DMb_ohe_sel_EX = 1'b1; // cp_extin_dmw_rd_ld_DMw_dm_addr_ID [ldst.n:64][cnn.n:105]
      end
      if (
      ...
      begin
        en_cnn_bin_sel_EX = 2'b01; // cnn_R_exp_xuA_cnn_EX [cnn.n:55]
      end
      if (
           ( reg_IR_ID[31:0] == 32'b11000000000000000111000000110011)                                      // 11000000000000000111000000110011
        || ( reg_IR_ID[31:25] == 7'b1100000 && reg_IR_ID[14:12] == 3'b001 && reg_IR_ID[6:0] == 7'b0110011) // 1100000xxxxxxxxxx001xxxxx0110011
      ...
      begin
        en_cnn_bin_sel_EX = 2'b10; // cnn_R_mac_xuC_xuA_xuB_cnn_EX [cnn.n:38][cnn.n:81]
      end
      if (
           ( reg_IR_ID[14] == 1'b1 && reg_IR_ID[6:0] == 7'b1100011) // xxxxxxxxxxxxxxxxx1xxxxxxx1100011
        || ( reg_IR_ID[13] == 1'b0 && reg_IR_ID[6:0] == 7'b1100011) // xxxxxxxxxxxxxxxxxx0xxxxxx1100011
      ...
      begin
        en_reg_X_bin_sel_EX = 2'b01; // X_wr_x_w1___X_x_w1_wad_EX [regX.n:101][cnn.n:81]
      end
      if (
           ( reg_IR_ID[13:12] == 2'b00 && reg_IR_ID[6:0] == 7'b0000011) // xxxxxxxxxxxxxxxxxx00xxxxx0000011
         )
      ...
      begin
        en_mux_x_w1_bin_sel_EX = 3'b101; // x_w1_copy0_cnn_w1_EX [cnn.n:58][cnn.n:81](regX.n:98)
      end
      if (
           ( reg_IR_ID[14] == 1'b0 && reg_IR_ID[12] == 1'b0 && reg_IR_ID[6:0] == 7'b0000011) // xxxxxxxxxxxxxxxxx0x0xxxxx0000011
        || ( reg_IR_ID[13] == 1'b0 && reg_IR_ID[6:0] == 7'b0000011)                          // xxxxxxxxxxxxxxxxxx0xxxxxx0000011
      ...
      begin
        en_mux___X_x_w1_wad_bin_sel_EX = 2'b01; // __X_x_w1_wad_copy0___CTt5u_cstP7_EX [regX.n:101]
      end
      if (
           ( reg_IR_ID[31:25] == 7'b0000000 && reg_IR_ID[11] == 1'b1 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:3] == 2'b10 && reg_IR_ID[1:0] == 2'b11)                                                      // 0000000xxxxxxxxxxxxx1xxxx0x10x11
        || ( reg_IR_ID[31:25] == 7'b0000000 && reg_IR_ID[10] == 1'b1 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:3] == 2'b10 && reg_IR_ID[1:0] == 2'b11)                                                      // 0000000xxxxxxxxxxxxxx1xxx0x10x11
      ...
      begin
        en_hazards_decode_EX[0] = 1'b1; // jalr_readHWraw1stEX  t5u_cstP7_EX[regX.n:101][cnn.n:42]
                                        // agu_read_after_writeHWraw1stEX  t5u_cstP7_EX[regX.n:101][cnn.n:42]
      end
    end
    ...
    predec_EX_enabling[17] = en_lx2_ohe_sel_EX;
    predec_EX_enabling[18] = en_controller_ohe_sel_EX;
    predec_EX_enabling[21] = en_reg_X_ohe_sel_EX;
    predec_EX_enabling[20:19] = en_reg_X_bin_sel_EX;
    predec_EX_enabling[25] = en_mem_DMb_ohe_sel_EX;
    predec_EX_enabling[24:22] = en_mem_DMb_bin_sel_EX;
    predec_EX_enabling[26] = en_mux_dmb_wr_ohe_sel_EX;
    predec_EX_enabling[29:27] = en_mux_x_w1_bin_sel_EX;
    predec_EX_enabling[30] = en_mux_x_w1_dead_ohe_sel_EX;
    predec_EX_enabling[31] = en_mux_aluA_ohe_sel_EX;
    predec_EX_enabling[33:32] = en_mux_aluB_bin_sel_EX;
    predec_EX_enabling[35:34] = en_mux_mpyM_bin_sel_EX;
    predec_EX_enabling[36] = en_mux_ocd_swbreak_ohe_sel_EX;
    predec_EX_enabling[38:37] = en_mux___X_x_w1_wad_bin_sel_EX;
    predec_EX_enabling[40:39] = en_hazards_decode_EX;
  end
