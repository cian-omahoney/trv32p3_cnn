...
module decoder
  ...
  reg    [31:0] EX_enabling;
  wire   [22:0] ID_enabling;
  wire   internal_mc_stall;
  wire   new_mc_reg_val;
  reg    [31:0] predec_EX_enabling;
  reg    [22:0] predec_ID_enabling;
  reg    reg_ID_valid;
  reg    [31:0] reg_IR_EX;
  reg    [31:0] reg_IR_ID;
  wire   trn_EX_valid;
  ...
  begin : decode_ID
    ...
    begin
      ...
      begin
        en_hazards_decode_ID[2] = 1'b1; // read_after_div_1HWraw2ndID  t5u_cstP15_EX[alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94]
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
      ...
      begin
        en_hazards_decode_ID[4] = 1'b1; // write_after_divHWwaw2ndID  t5u_cstP7_EX[regX.n:101]
      end
      if (
           ( reg_IR_ID[31:25] == 7'b0000001 && reg_IR_ID[14] == 1'b1 && reg_IR_ID[6:0] == 7'b0110011) // 0000001xxxxxxxxxx1xxxxxxx0110011
         )
      begin
        en_hazards_decode_ID[5] = 1'b1; // div_busyHWnoDep2ndID
      end
      if (
      ...
      begin
        en_hazards_decode_ID[6] = 1'b1; // div_wpHWnoDep2ndID
      end
    end
    if (hzd_stall_in)
    begin
    ...
    predec_ID_enabling[22:16] = en_hazards_decode_ID;
  end
  ...
  begin : decode_EX
    ...
    begin
      ...
      begin
        ...
        __X_x_r1_raddr_EX = reg_IR_ID[19:15]; // __X_x_r1_raddr_cp___CTt5u_cstP15_EX_EX [alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94](regX.n:77)
      end
      if (
           ( reg_IR_ID[31:26] == 6'b000000 && reg_IR_ID[6:0] == 7'b0110011)                                                                               // 000000xxxxxxxxxxxxxxxxxxx0110011
        || ( reg_IR_ID[31] == 1'b0 && reg_IR_ID[29:25] == 5'b00000 && reg_IR_ID[14:12] == 3'b000 && reg_IR_ID[6:5] == 2'b01 && reg_IR_ID[3:0] == 4'b0011) // 0x00000xxxxxxxxxx000xxxxx01x0011
      ...
      begin
        en_reg_X_ohe_sel_EX = 1'b1;            // X_wr_x_w1___X_x_w1_wad_EX [regX.n:101]
        en_mux___X_x_w1_wad_ohe_sel_EX = 1'b1; // __X_x_w1_wad_copy0___CTt5u_cstP7_EX [regX.n:101]
        en_hazards_decode_EX = 1'b1;           // jalr_readHWraw1stEX  t5u_cstP7_EX[regX.n:101]
      ...
      begin
        en_mux_x_w1_bin_sel_EX = 3'b101; // x_w1_copy0_lxR_EX [ldst.n:75](regX.n:98)
      end
      if (
           ( reg_IR_ID[14:12] == 3'b000 && reg_IR_ID[6:4] == 3'b110 && reg_IR_ID[2:0] == 3'b111) // xxxxxxxxxxxxxxxxx000xxxxx110x111
        || ( reg_IR_ID[6:0] == 7'b1101111)                                                       // xxxxxxxxxxxxxxxxxxxxxxxxx1101111
      ...
      begin
        en_mux_x_w1_bin_sel_EX = 3'b110; // x_w1_copy0_pidTGT_EX [ctrl.n:157][ctrl.n:196](regX.n:98)
      end
      if (
           ( reg_IR_ID[31:25] == 7'b0000000 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:0] == 5'b10011)                                                      // 0000000xxxxxxxxxxxxxxxxxx0x10011
        || ( reg_IR_ID[31] == 1'b0 && reg_IR_ID[29:25] == 5'b00000 && reg_IR_ID[14:12] == 3'b000 && reg_IR_ID[6] == 1'b0 && reg_IR_ID[4:0] == 5'b10011) // 0x00000xxxxxxxxxx000xxxxx0x10011
    ...
    predec_EX_enabling[15] = en_controller_ohe_sel_EX;
    predec_EX_enabling[16] = en_reg_X_ohe_sel_EX;
    predec_EX_enabling[19:17] = en_mem_DMb_bin_sel_EX;
    predec_EX_enabling[20] = en_mux_dmb_wr_ohe_sel_EX;
    predec_EX_enabling[23:21] = en_mux_x_w1_bin_sel_EX;
    predec_EX_enabling[24] = en_mux_aluA_ohe_sel_EX;
    predec_EX_enabling[26:25] = en_mux_aluB_bin_sel_EX;
    predec_EX_enabling[28:27] = en_mux_mpyM_bin_sel_EX;
    predec_EX_enabling[29] = en_mux_ocd_swbreak_ohe_sel_EX;
    predec_EX_enabling[30] = en_mux___X_x_w1_wad_ohe_sel_EX;
    predec_EX_enabling[31] = en_hazards_decode_EX;
  end
