...
task w32_incmac_w32_w32_w32_w32_w32_w32_w32
  ( output reg signed [31:0] result_0,
    input      signed [31:0] c,
    input      signed [31:0] a,
    input      signed [31:0] b,
    input      signed [31:0] a_addr_i,
    output reg signed [31:0] a_addr_o,
    input      signed [31:0] b_addr_i,
    output reg signed [31:0] b_addr_o
  );
  begin : w32_incmac_w32_w32_w32_w32_w32_w32_w32_task
    reg signed [31:0] multResult;
    reg signed [31:0] result;
    reg signed [63:0] multResult_0;
    reg signed [31:0] INT32_SATURATION_result;
    ...
    INT32_SATURATION_result_0 = saturatedResult_0;
    result = INT32_SATURATION_result_0;
    a_addr_o = a_addr_i + 32'sh1;
    b_addr_o = b_addr_i + 32'sh4;
    result_0 = result;
  end
endtask
