...
module reg_X
  ...
  begin : p_read_reg_X
    ...
    // [alu.n:69][alu.n:131][alu.n:167][mpy.n:61][div.n:58][ctrl.n:94][cnn.n:33][cnn.n:53](regX.n:77)(regX.n:123)
    x_r1_out = reg_val[__X_x_r1_raddr_in];

    // (x_r2_rd_X___X_x_r2_rad_EX)
    // [alu.n:70][mpy.n:62][div.n:59][ldst.n:99][ldst.n:100][ldst.n:101][ctrl.n:95][cnn.n:34](regX.n:84)(regX.n:116)
    x_r2_out = reg_val[__X_x_r2_raddr_in];

    // (x_r3_rd_X___X_x_r3_rad_EX)
    // [cnn.n:35][ldst.n:54][ldst.n:91][ctrl.n:189](regX.n:109)(regX.n:91)
