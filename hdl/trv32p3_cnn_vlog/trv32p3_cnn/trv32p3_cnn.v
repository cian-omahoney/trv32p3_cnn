...
module trv32p3_cnn
  ...
  wire   signed [31:0] z_r1; // w32
  wire   signed [31:0] z_r2; // w32
  wire   signed [31:0] z_r3; // w32
  wire   signed [31:0] z_r4; // w32
  wire   signed [31:0] z_r5; // w32
  wire   signed [31:0] cnn_R; // w32
  wire   signed [31:0] z_w3; // w32
  wire   signed [31:0] z_w4; // w32
  wire   signed [31:0] z_w5; // w32
  ...
  inst_reg_X(
      .reset(reset),
      .clock(clock),
      .bin_selector_EX(EX_enabling[19:18]),
  ...
  mem_DMb inst_mem_DMb(
      .bin_selector_EX(EX_enabling[22:20]),
  ...
  mux_dmb_wr inst_mux_dmb_wr(
      .ohe_selector_EX(EX_enabling[23]),
      .__ocd_st_DMbS3_r_in(__ocd_st_DMbS3_r),
  ...
  mux_x_w1 inst_mux_x_w1(
      .bin_selector_EX(EX_enabling[26:24]),
      .X_x_w1_div_main_pdg_en_in(X_x_w1_div_main_pdg_en),
  ...
  mux_aluB inst_mux_aluB(
      .bin_selector_EX(EX_enabling[30:29]),
  ...
  mux_mpyM inst_mux_mpyM(
      .bin_selector_EX(EX_enabling[32:31]),
      .mpyM_out(mpyM));
  ...
  mux___X_x_w1_wad inst_mux___X_x_w1_wad(
      .ohe_selector_EX(EX_enabling[34]),
      .X_x_w1_div_main_pdg_en_in(X_x_w1_div_main_pdg_en),
  ...
  hazards inst_hazards(
      ...
      .hazards_decode_EX(EX_enabling[36:35]),
