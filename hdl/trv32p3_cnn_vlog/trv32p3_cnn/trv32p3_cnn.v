...
module trv32p3_cnn
  ...
  wire   signed [31:0] dmw_rd2_dp; // w32
  wire   signed [31:0] x_w7; // w32
  wire   signed [31:0] aguA2; // w32
  wire   signed [31:0] aguB2; // w32
  wire   signed [31:0] aguR2; // w32
  ...
  wire   signed [31:0] x_w3; // w32
  wire   signed [31:0] x_w4; // w32
  wire   signed [31:0] x_w5; // w32
  wire   signed [31:0] x_w6; // w32
  wire   signed [31:0] x_r1; // w32
  wire   signed [31:0] x_r2; // w32
  wire   signed [31:0] x_r3; // w32
  wire   signed [31:0] x_r4; // w32
  wire   signed [31:0] x_r5; // w32
  wire   signed [31:0] x_r6; // w32
  wire   signed [31:0] x_r7; // w32
  ...
  assign jtag_tms = jtag_tms_in;
  assign jtag_tdi = jtag_tdi_in;
  assign jtag_tdo_out = jtag_tdo;
  ...
  // [ldst.n:100](regX.n:84)
  assign dmh_wr_dp = $signed(x_r2[15:0]);

  // expanded mux_dm_addr2
  // (dm_addr2_copy0_aguA2_ID)
  // [cnn.n:122]
  assign dm_addr2_dp = $unsigned(aguA2);

  // expanded mux_dmw_wr
  // (dmw_wr_copy0_x_r2_EX)
  // [ldst.n:101](regX.n:84)
  ...
  cnn inst_cnn(
      .bin_selector_EX(EX_enabling[16:15]),
      .xuA_in(xuA),
      .xuB_in(xuB),
      .xuC_in(xuC),
      .cnn_R_out(cnn_R));
  ...
  lx2 inst_lx2(
      .ohe_selector_EX(EX_enabling[17]),
      .dmw_rd2_dp_in(dmw_rd2_dp),
      .x_w7_out(x_w7));

  agu2 inst_agu2(
      .ohe_selector_ID(ID_enabling[2]),
      .aguA2_in(aguA2),
      .aguB2_in(aguB2),
      .aguR2_out(aguR2));
  ...
  controller inst_controller(
      .reset(reset),
      .clock(clock),
      .ohe_selector_EX(EX_enabling[18]),
      .bin_selector_ID(ID_enabling[4:3]),
      .cnd_in(cnd),
  ...
  inst_reg_X(
      .reset(reset),
      .clock(clock),
      .ohe_selector_EX(EX_enabling[21]),
      .bin_selector_EX(EX_enabling[20:19]),
  ...
  mem_DMb inst_mem_DMb(
      .ohe_selector_EX(EX_enabling[25]),
      .bin_selector_EX(EX_enabling[24:22]),
      .ohe_selector_ID(ID_enabling[7]),
      .bin_selector_ID(ID_enabling[10:8]),
      .__ocd_ld_DMbEX_r_in(__ocd_ld_DMbEX_r),
      .__ocd_st_DMbEX_r_in(__ocd_st_DMbEX_r),
      .__ocd_st_DMbS3_r_in(__ocd_st_DMbS3_r),
      .dm_addr2_dp_in(dm_addr2_dp),
  ...
  mux_x_w1 inst_mux_x_w1(
      .bin_selector_EX(EX_enabling[29:27]),
      .X_x_w1_div_main_pdg_en_in(X_x_w1_div_main_pdg_en),
  ...
  mux_x_w2 inst_mux_x_w2(
      .ohe_selector_ID(ID_enabling[13]),
      .cnn_R_in(cnn_R),
      .x_r5_in(x_r5),
      .x_w2_out(x_w2));

  mux_x_w1_dead inst_mux_x_w1_dead(
      .ohe_selector_EX(EX_enabling[30]),
      .cnn_R_in(cnn_R),
      .x_w1_in(x_w1),
  ...
  mux_aluA inst_mux_aluA(
      .ohe_selector_EX(EX_enabling[31]),
      .PC_EX_r_in(PC_EX_r),
      .x_r1_in(x_r1),
      .aluA_out(aluA));

  mux_aluB inst_mux_aluB(
      .bin_selector_EX(EX_enabling[33:32]),
  ...
  mux_pcaA inst_mux_pcaA(
      .ohe_selector_ID(ID_enabling[14]),
      .PC_ID_r_in(PC_ID_r),
      .x_r3_in(x_r3),
      .pcaA_out(pcaA));

  mux_pcaB inst_mux_pcaB(
      .bin_selector_ID(ID_enabling[16:15]),
  ...
  mux___X_x_w1_wad inst_mux___X_x_w1_wad(
      .bin_selector_EX(EX_enabling[38:37]),
      .X_x_w1_div_main_pdg_en_in(X_x_w1_div_main_pdg_en),
  ...
  hazards inst_hazards(
      .hazards_decode_ID(ID_enabling[30:22]),
      .hazards_decode_EX(EX_enabling[40:39]),
