...
module trv32p3_cnn
  ...
  mem_DMb inst_mem_DMb(
      .bin_selector_EX(EX_enabling[19:17]),
  ...
  mux_dmb_wr inst_mux_dmb_wr(
      .ohe_selector_EX(EX_enabling[20]),
      .__ocd_st_DMbS3_r_in(__ocd_st_DMbS3_r),
  ...
  mux_x_w1 inst_mux_x_w1(
      .bin_selector_EX(EX_enabling[23:21]),
      .X_x_w1_div_main_pdg_en_in(X_x_w1_div_main_pdg_en),
  ...
  mux_aluA inst_mux_aluA(
      .ohe_selector_EX(EX_enabling[24]),
      .PC_EX_r_in(PC_EX_r),
      .x_r1_in(x_r1),
      .aluA_out(aluA));

  mux_aluB inst_mux_aluB(
      .bin_selector_EX(EX_enabling[26:25]),
  ...
  mux_mpyM inst_mux_mpyM(
      .bin_selector_EX(EX_enabling[28:27]),
      .mpyM_out(mpyM));
  ...
  hazards inst_hazards(
      .hazards_decode_ID(ID_enabling[22:16]),
