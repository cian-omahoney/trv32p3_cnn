...
architecture rtl of pipe_ocd_st_PMbEX is
  signal pipe_val_ocd_st_PMbEX_r_out : boolean;
begin

  ocd_st_PMbEX_r_out <= pipe_val_ocd_st_PMbEX_r_out;

  p_pipe_ocd_st_PMbEX : process(clock)
  begin
    if clock'event and clock = '1' then
      -- (_pipe__ocd_st_PMbID_EX)
      pipe_val_ocd_st_PMbEX_r_out <= ocd_st_PMbID_w_in;

    end if;
  end process p_pipe_ocd_st_PMbEX;
end rtl;
