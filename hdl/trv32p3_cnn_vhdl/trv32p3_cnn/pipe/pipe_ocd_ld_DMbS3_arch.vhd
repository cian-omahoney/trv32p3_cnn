...
architecture rtl of pipe_ocd_ld_DMbS3 is
  signal pipe_val_ocd_ld_DMbS3_r_out : boolean;
begin

  ocd_ld_DMbS3_r_out <= pipe_val_ocd_ld_DMbS3_r_out;

  p_pipe_ocd_ld_DMbS3 : process(clock)
  begin
    if clock'event and clock = '1' then
      -- (_pipe__ocd_ld_DMbEX_S3)
      pipe_val_ocd_ld_DMbS3_r_out <= ocd_ld_DMbEX_w_in;

    end if;
  end process p_pipe_ocd_ld_DMbS3;
end rtl;
