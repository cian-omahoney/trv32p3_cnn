...
tool for early RTL exploration and to run the Design Compiler NXT/Design Compiler tool for synthesis. 
...
For the Design Compiler NXT/Design Compiler tool, the reference methodology provides a common set of 
...
tool by entering the dcnxt_shell/dc_shell command with the -topographical_mode option) and 
...
1. Run your RTL exploration or synthesis by using the dc.tcl script.
  ...
  o  To run the Design Compiler NXT tool, enter the following command:
