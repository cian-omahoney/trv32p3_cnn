...
set DESIGN_NAME 		"" ;# Required; name of the design to be worked on; used as the block name for save_block or copy_block operations
...
##################################################
set REFERENCE_LIBRARY 		[list ]	;# Required; a list of reference libraries for the design library.
...
set RTL_SOURCE_FORMAT		sverilog ;# Specify one format out of verilog | sverilog | vhdl | script
                                                 ;# RTL source files when RTL_SOURCE_FORMAT = verilog | sverilog | vhdl
set RTL_SOURCE_FILES		{}       ;# RTL read scripts when RTL_SOURCE_FORMAT = script
set FC_RTL_READ_SCRIPT		${DESIGN_NAME}.FC.read_design.tcl
set FM_RTL_READ_SCRIPT		${DESIGN_NAME}.FM.read_design.tcl
set UPF_MODE      		"prime" ;# prime | golden | none; Defines the UPF mode. By default the UPF prime mode. Can also select 
