/*
-- File : trv32p3_cnn_pdc_interface.c
--
-- Contents : Specialisation of Checkers_pdc_interface for TRV32P3_CNN
--
...
#include "trv32p3_cnn_pdc_interface.h"
...
trv32p3_cnn_pdc_interface::trv32p3_cnn_pdc_interface(int coreid, std::string server,
                                             int port)
  : Checkers_pdc_interface(coreid, server, port)
{
}

VBitWrapper trv32p3_cnn_pdc_interface::get_instruction_at(AddressType pc)
{
  unsigned ilen = 32;
  DataType byte;
...
void trv32p3_cnn_pdc_interface::put_instruction_at(AddressType pc, VBitWrapper instr) {
...
AddressType trv32p3_cnn_pdc_interface::next_instruction(AddressType pc) {
  return pc + (get_instruction_at(pc).getBitSize() / 8);
}

AddressType trv32p3_cnn_pdc_interface::prev_instruction(AddressType pc) {
...
void trv32p3_cnn_pdc_interface::populate_common_scl_regs() {
//  // load all X[] fields
