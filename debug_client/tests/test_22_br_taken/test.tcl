...
# strictly prohibited.
#
# Tcl script to test trv32p3_cnn on chip debugging TUI.
#
...
namespace eval tests {
  ...
  #    testcase $bptype $step {24 28}
    ...
    ## external requests
    if {$step == -1} {
      if {[info exists ::have_vcs_control] && $::have_vcs_control} {
        puts "Running ext-break tests"
        # simple one
...
#  if {[::rpc::connect]} {
#    set ::have_vcs_control 1
#    puts "We have VCS control"
#  }
