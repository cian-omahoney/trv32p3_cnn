...
extern __C__ __regcall int chessintr___sint_ReLU___sint(int) __attribute__((const));
inline __attribute__((always_inline,nodebug)) int ReLU(int a0) __attribute__((overloadable))
{
    return chessintr___sint_ReLU___sint(a0);
}


#ifdef __cplusplus
struct chessout___sint_incmac___sint___sint___sint___sint___sint___sint___sint {
    int o0 __attribute__((packed));
    int o1 __attribute__((packed));
    int o2 __attribute__((packed));
} __attribute__((packed));
extern __C__ __regcall struct chessout___sint_incmac___sint___sint___sint___sint___sint___sint___sint chessintr___sint_incmac___sint___sint___sint___sint___sint___sint___sint(int, int, int, int, int) __attribute__((const));
template <typename R4, typename R6>
inline __attribute__((always_inline,nodebug)) typename chessEnableIf<chessIsCompatible<typename chessRemoveQual<R4>::type, int>::value && chessIsCompatible<typename chessRemoveQual<R6>::type, int>::value, int>::type incmac(int a0, int a1, int a2, int a3, R4 &a4, int a5, R6 &a6) __attribute__((overloadable))
{
    struct chessout___sint_incmac___sint___sint___sint___sint___sint___sint___sint out = chessintr___sint_incmac___sint___sint___sint___sint___sint___sint___sint(a0, a1, a2, a3, a5);
    a4 = out.o1;
    a6 = out.o2;
    return out.o0;
}
