...
#ifndef _trv32p3_iss_types_h
#define _trv32p3_iss_types_h
...
#ifdef __cplusplus
template <> struct chessTraitsOf<trv32p3_primitive::w08> {
    static const unsigned bits = 8;
};
template <> struct chessTraitsOf<trv32p3_primitive::w16> {
    static const unsigned bits = 16;
};
template <> struct chessTraitsOf<trv32p3_primitive::w32> {
    static const unsigned bits = 32;
};
template <> struct chessTraitsOf<trv32p3_primitive::u08> {
    static const unsigned bits = 8;
};
template <> struct chessTraitsOf<trv32p3_primitive::addr> {
    static const unsigned bits = 32;
};
template <> struct chessTraitsOf<trv32p3_primitive::iword> {
    static const unsigned bits = 32;
};
template <> struct chessTraitsOf<trv32p3_primitive::t1u> {
    static const unsigned bits = 1;
};
template <> struct chessTraitsOf<trv32p3_primitive::t2u> {
    static const unsigned bits = 2;
};
template <> struct chessTraitsOf<trv32p3_primitive::t5u> {
    static const unsigned bits = 5;
};
template <> struct chessTraitsOf<trv32p3_primitive::t6u> {
    static const unsigned bits = 6;
};
template <> struct chessTraitsOf<trv32p3_primitive::t8u> {
    static const unsigned bits = 8;
};
template <> struct chessTraitsOf<trv32p3_primitive::t12s> {
    static const unsigned bits = 12;
};
template <> struct chessTraitsOf<trv32p3_primitive::t5unz> {
    static const unsigned bits = 5;
};
template <> struct chessTraitsOf<trv32p3_primitive::t13s_s2> {
    static const unsigned bits = 13;
};
template <> struct chessTraitsOf<trv32p3_primitive::t20s_rp12> {
    static const unsigned bits = 20;
};
template <> struct chessTraitsOf<trv32p3_primitive::t21s_s2> {
    static const unsigned bits = 21;
};
template <> struct chessTraitsOf<trv32p3_primitive::t31s_rp1> {
    static const unsigned bits = 31;
};
template <> struct chessTraitsOf<trv32p3_primitive::w64> {
