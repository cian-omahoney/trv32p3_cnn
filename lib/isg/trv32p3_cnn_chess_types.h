...
inline int chess_assert_(trv32p3_cnn_primitive::v22w32 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
...
inline void chess_report(trv32p3_cnn_primitive::v22w32 a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_cnn_primitive::v22w32):";
    for (int i = 0; i < 22; i++) chess_report_hex(32, toVBit(a.elem(i)).value(), os);
    os << " //";
    for (int i = 0; i < 22; i++) chess_report_signed(toVBit(a.elem(i)).value(), os);
    os << std::endl;
}
