...
#ifndef _trv32p3_chess_types_h
#define _trv32p3_chess_types_h
...
inline int chess_assert_(trv32p3_primitive::w08 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::w16 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::w32 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::u08 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::addr a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::iword a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t1u a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t2u a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t5u a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t6u a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t8u a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t12s a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t5unz a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t13s_s2 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t20s_rp12 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t21s_s2 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::t31s_rp1 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
inline int chess_assert_(trv32p3_primitive::w64 a) {
  return toVBit(a) != 0 ? 1 : 0;
}
...
inline void chess_report(trv32p3_primitive::w08 a) {
    std::ostream& os = chess_report_os;
...
inline void chess_report(trv32p3_primitive::w16 a) {
    std::ostream& os = chess_report_os;
...
inline void chess_report(trv32p3_primitive::w32 a) {
    std::ostream& os = chess_report_os;
...
inline void chess_report(trv32p3_primitive::u08 a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::u08):";
    chess_report_hex(8, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::addr a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::addr):";
    chess_report_hex(32, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::iword a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::iword):";
    chess_report_hex(32, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t1u a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t1u):";
    chess_report_hex(1, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t2u a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t2u):";
    chess_report_hex(2, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t5u a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t5u):";
    chess_report_hex(5, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t6u a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t6u):";
    chess_report_hex(6, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t8u a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t8u):";
    chess_report_hex(8, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t12s a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t12s):";
    chess_report_hex(12, toVBit(a).value(), os);
    os << " //";
    chess_report_signed(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t5unz a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t5unz):";
    chess_report_hex(5, toVBit(a).value(), os);
    os << " //";
    chess_report_unsigned(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t13s_s2 a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t13s_s2):";
    chess_report_hex(13, toVBit(a).value(), os);
    os << " //";
    chess_report_signed(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t20s_rp12 a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t20s_rp12):";
    chess_report_hex(20, toVBit(a).value(), os);
    os << " //";
    chess_report_signed(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t21s_s2 a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t21s_s2):";
    chess_report_hex(21, toVBit(a).value(), os);
    os << " //";
    chess_report_signed(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::t31s_rp1 a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::t31s_rp1):";
    chess_report_hex(31, toVBit(a).value(), os);
    os << " //";
    chess_report_signed(toVBit(a).value(), os);
    os << std::endl;
}
inline void chess_report(trv32p3_primitive::w64 a) {
    std::ostream& os = chess_report_os;
    os << "chess_report(trv32p3_primitive::w64):";
...
// stub, but with correct (largest suitable) return type on trv32p3 (may influence C++ overloading)
