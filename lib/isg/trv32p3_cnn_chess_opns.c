...
#include "trv32p3_cnn_chess_opns.h"
...
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 p1 = a1;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::mulh(p0, p1);
...
CHESS_NATIVE_LINKAGE unsigned mulh(unsigned a0, unsigned a1)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 p1 = a1;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::mulhu(p0, p1);
...
CHESS_NATIVE_LINKAGE int mulh(int a0, unsigned a1)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 p1 = a1;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::mulhsu(p0, p1);
    int r; r = toVBit(t).value();
    return r;
}
...
CHESS_NATIVE_LINKAGE long long lmul(int a0, int a1)
{
    int p0 = a0;
    int p1 = a1;
    trv32p3_cnn_primitive::dint t = trv32p3_cnn_primitive::l_mul(p0, p1);
...
CHESS_NATIVE_LINKAGE int slt(int a0, int a1)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 p1 = a1;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::slt(p0, p1);
    int r; r = toVBit(t).value();
    return r;
}
...
CHESS_NATIVE_LINKAGE int slt(unsigned a0, unsigned a1)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 p1 = a1;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::sltu(p0, p1);
    int r; r = toVBit(t).value();
    return r;
}
...
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::seq0(p0);
    int r; r = toVBit(t).value();
    return r;
}
...
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::sne0(p0);
    int r; r = toVBit(t).value();
    return r;
}
...
namespace trv32p3_cnn_primitive {
    CHESS_NATIVE_LINKAGE w32 iexp(w32 a)
    {
     return exp(a);
    }
} //namespace trv32p3_cnn_primitive
...
namespace trv32p3_cnn_primitive {
    CHESS_NATIVE_LINKAGE w32 irelu(w32 a)
    {
     return prelu(a);
    }
} //namespace trv32p3_cnn_primitive
...
namespace trv32p3_cnn_primitive {
    CHESS_NATIVE_LINKAGE w32 iincmac(w32 c, w32 a, w32 b, w32 a_addr_i, w32 &a_addr_o, w32 b_addr_i, w32 &b_addr_o)
    {
...
CHESS_NATIVE_LINKAGE int MyMAC(int a0, int a1, int a2)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 p1 = a1;
    trv32p3_cnn_primitive::w32 p2 = a2;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::imac(p0, p1, p2);
    int r; r = toVBit(t).value();
    return r;
}

CHESS_NATIVE_LINKAGE int exp(int a0)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::iexp(p0);
    int r; r = toVBit(t).value();
    return r;
}

CHESS_NATIVE_LINKAGE int ReLU(int a0)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::irelu(p0);
    int r; r = toVBit(t).value();
    return r;
}

CHESS_NATIVE_LINKAGE int incmac(int a0, int a1, int a2, int a3, int & a4, int a5, int & a6)
{
    trv32p3_cnn_primitive::w32 p0 = a0;
    trv32p3_cnn_primitive::w32 p1 = a1;
    trv32p3_cnn_primitive::w32 p2 = a2;
    trv32p3_cnn_primitive::w32 p3 = a3;
    trv32p3_cnn_primitive::w32 p4; //output
    trv32p3_cnn_primitive::w32 p5 = a5;
    trv32p3_cnn_primitive::w32 p6; //output
    trv32p3_cnn_primitive::w32 t = trv32p3_cnn_primitive::iincmac(p0, p1, p2, p3, p4, p5, p6);
    a4 = toVBit(p4).value();
    a6 = toVBit(p6).value();
    int r; r = toVBit(t).value();
    return r;
