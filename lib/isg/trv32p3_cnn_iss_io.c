...
static inline void unpacklla(const long long* val, long long* eval, int n, int s, bool sgnd) // do not warn when unused
{
    // unpack val[(n*s+63)/64] in eval[n] containing values of s (<=64) bits

    int j = 0, lsb = 0, dim = (n*s+63)/64;
    unsigned long long v = val[0];          // load first pack

    for (int i = 0; i < n; i++) {
        unsigned long long w = v >> lsb;    // extract bits in current pack
        lsb += s;
        if (lsb >= 64) {
            v = ++j < dim ? val[j] : 0; // load next pack
            lsb -= 64;
            w |= s-lsb < 64 ? v << (s-lsb) : 0; // extract remaining bits
        }
        eval[i] = sgnd ? CHESS_EXTENDLL(w,s) : CHESS_MASKLL(w,s);  // format
    }
}

static inline void repacklla(long long* val, const long long* eval, int n, int s) // do not warn when unused
{
    // repack val[(n*s+63)/64] from eval[n] containing values of s (<=64) bits

    int j = 0, lsb = 0, dim = (n*s+63)/64;
    unsigned long long v = 0;               // init pack

    for (int i = 0; i < n; i++) {
        unsigned long long w = CHESS_MASKLL(eval[i],s);
        v |= w << lsb;
        lsb += s;
        if (lsb >= 64) {
            val[j++] = v;               // store pack
            lsb -= 64;
            v = s-lsb < 64 ? w >> (s-lsb) : 0; // extract remaining bits
        }
    }
    if (j < dim) val[j] = v;            // store last pack
}
...
#endif
#ifdef checkers_[=getdesign_name=]_PC_ID_si
# define chess_[=getdesign_name=]_PC_ID_si checkers_[=getdesign_name=]_PC_ID_si
#else
# define chess_[=getdesign_name=]_PC_ID_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_PC_EX_si
# define chess_[=getdesign_name=]_PC_EX_si checkers_[=getdesign_name=]_PC_EX_si
#else
# define chess_[=getdesign_name=]_PC_EX_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_X_si
# define chess_[=getdesign_name=]_X_si checkers_[=getdesign_name=]_X_si
#else
# define chess_[=getdesign_name=]_X_si (-1)
#endif
...
#endif
#ifdef checkers_[=getdesign_name=]_X10_si
# define chess_[=getdesign_name=]_X10_si checkers_[=getdesign_name=]_X10_si
#else
# define chess_[=getdesign_name=]_X10_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_X11_si
# define chess_[=getdesign_name=]_X11_si checkers_[=getdesign_name=]_X11_si
#else
# define chess_[=getdesign_name=]_X11_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_X12_si
# define chess_[=getdesign_name=]_X12_si checkers_[=getdesign_name=]_X12_si
#else
# define chess_[=getdesign_name=]_X12_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_X13_si
# define chess_[=getdesign_name=]_X13_si checkers_[=getdesign_name=]_X13_si
#else
# define chess_[=getdesign_name=]_X13_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_X14_si
# define chess_[=getdesign_name=]_X14_si checkers_[=getdesign_name=]_X14_si
#else
# define chess_[=getdesign_name=]_X14_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_X15_si
# define chess_[=getdesign_name=]_X15_si checkers_[=getdesign_name=]_X15_si
#else
# define chess_[=getdesign_name=]_X15_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_X16_si
# define chess_[=getdesign_name=]_X16_si checkers_[=getdesign_name=]_X16_si
#else
# define chess_[=getdesign_name=]_X16_si (-1)
#endif
...
int [=getdesign_name=]_read0_pad12(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    Checkers_stor_addr sta(si, addr, 1, at_addr);
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return uicore->errors.put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_read0_pad12");
    DataType vval = sti->vbit(0);
    int rt = chkapi_l_storage_get_vbit(uicore, sta, vval);
    val[0] = vval.as_signed().to_longlong();
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read value", "[=getdesign_name=]_read0_pad12");
    val[0] >>= 12; /* right padding */
    return chkapi_OK;
}

int [=getdesign_name=]_write0_pad12(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    long long tval[1];
    tval[0] = val[0] << 12; /* right padding */
    Checkers_stor_addr sta(si, addr, 1, at_addr);
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return uicore->errors.put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_write0_pad12");
    DataType vval = sti->vbit((int)tval[0]);
    int rt = chkapi_l_storage_put_vbit(uicore, sta, vval);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write value", "[=getdesign_name=]_write0_pad12");
    return chkapi_OK;
}

int [=getdesign_name=]_read0_unknown(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    Checkers_stor_addr sta(si, addr, 1, at_addr);
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return uicore->errors.put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_read0_unknown");
    DataType vval = sti->vbit(0);
    int rt = chkapi_l_storage_get_vbit(uicore, sta, vval);
    val[0] = vval.as_signed().to_longlong();
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read value", "[=getdesign_name=]_read0_unknown");
    //val[0] = ...; /* unfoldable */
    return chkapi_OK;
}

int [=getdesign_name=]_write0_unknown(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    long long tval[1];
    tval[0] = val[0]; /* unfoldable */
    Checkers_stor_addr sta(si, addr, 1, at_addr);
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return uicore->errors.put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_write0_unknown");
    DataType vval = sti->vbit((int)tval[0]);
    int rt = chkapi_l_storage_put_vbit(uicore, sta, vval);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write value", "[=getdesign_name=]_write0_unknown");
    return chkapi_OK;
}
...
int [=getdesign_name=]_read0_pad12_DMw(Checkers_uicore* uicore, long long* val, int n, int /*si*/, AddressType addr)
{
    return [=getdesign_name=]_read0_pad12(uicore, val, n, chess_[=getdesign_name=]_DMw_si, addr);
}

int [=getdesign_name=]_write0_pad12_DMw(Checkers_uicore* uicore, const long long* val, int n, int /*si*/, AddressType addr)
{
    return [=getdesign_name=]_write0_pad12(uicore, val, n, chess_[=getdesign_name=]_DMw_si, addr);
}
...
int [=getdesign_name=]_read0_pad12_DMw_stat(Checkers_uicore* uicore, long long* val, int n, int /*si*/, AddressType addr)
{
    return [=getdesign_name=]_read0_pad12(uicore, val, n, chess_[=getdesign_name=]_DMw_stat_si, addr);
}

int [=getdesign_name=]_write0_pad12_DMw_stat(Checkers_uicore* uicore, const long long* val, int n, int /*si*/, AddressType addr)
{
    return [=getdesign_name=]_write0_pad12(uicore, val, n, chess_[=getdesign_name=]_DMw_stat_si, addr);
}

//--- read/write for chess_convert or keep_in_registers representation ---

int [=getdesign_name=]_read1_record0/*__cnvt_bool*/(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record0/*__cnvt_bool*/");
...
int [=getdesign_name=]_write1_record0/*__cnvt_bool*/(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record0/*__cnvt_bool*/");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record1/*dint*/(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_read0_DMw(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record1/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0_DMw(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record1/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_write1_record1/*dint*/(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_write0_DMw(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record1/*dint*/");
    // component 1 : 32 bits at 32
    fval[0] = CHESS_EXTENDLL(tval[0] >> 32, 32);
    rt = [=getdesign_name=]_write0_DMw(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record1/*dint*/");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record2/*__cnvt_bool*/(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record2/*__cnvt_bool*/");
    val[0] |= CHESS_MASKLL(fval[0], 1) << 0;
    // complete
    val[0] = CHESS_EXTENDLL(val[0],1);
    return chkapi_OK;
...
int [=getdesign_name=]_write1_record2/*__cnvt_bool*/(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record2/*__cnvt_bool*/");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record3/*dint*/(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record3/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record3/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_write1_record3/*dint*/(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record3/*dint*/");
    // component 1 : 32 bits at 32
    fval[0] = CHESS_EXTENDLL(tval[0] >> 32, 32);
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record3/*dint*/");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record4/*__cnvt_bool*/(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record4/*__cnvt_bool*/");
    val[0] |= CHESS_MASKLL(fval[0], 1) << 0;
    // complete
    val[0] = CHESS_EXTENDLL(val[0],1);
    return chkapi_OK;
...
int [=getdesign_name=]_write1_record4/*__cnvt_bool*/(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record4/*__cnvt_bool*/");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record5/*dint*/(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_read0_DMw_stat(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record5/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0_DMw_stat(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record5/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_write1_record5/*dint*/(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_write0_DMw_stat(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record5/*dint*/");
    // component 1 : 32 bits at 32
    fval[0] = CHESS_EXTENDLL(tval[0] >> 32, 32);
    rt = [=getdesign_name=]_write0_DMw_stat(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record5/*dint*/");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record6/*dint*/(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record6/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 1);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record6/*dint*/");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_write1_record6/*dint*/(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record6/*dint*/");
    // component 1 : 32 bits at 32
    fval[0] = CHESS_EXTENDLL(tval[0] >> 32, 32);
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 1);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record6/*dint*/");
    // complete
    return chkapi_OK;
}
...
int [=getdesign_name=]_readstring0_unknown(Checkers_uicore* uicore, std::string& val, int si, int csz, AddressType addr)
{
    val = "";
    while (1) {
        long long cval = 0;
        int rt = [=getdesign_name=]_read0_unknown(uicore, &cval,1, si, addr);
        if (rt != chkapi_OK)
            return uicore->errors.put(rt, "Could not read character from string", "[=getdesign_name=]_readstring0_unknown");
        if (!cval) break;
        val += (char)(cval & 0xff);
        addr += csz;
    }
...
int [=getdesign_name=]_writestring0_unknown(Checkers_uicore* uicore, std::string val, int si, int csz, AddressType addr, int term_zero)
{
    for (unsigned i = 0; i < val.length(); i++) {
        long long cval = val[i];
        int rt = [=getdesign_name=]_write0_unknown(uicore, &cval,1, si, addr);
        if (rt != chkapi_OK)
            return uicore->errors.put(rt, "Could not write character from string", "[=getdesign_name=]_writestring0_unknown");
        addr += csz;
    }
    if (term_zero) {
        long long cval = 0;
        int rt = [=getdesign_name=]_write0_unknown(uicore, &cval,1, si, addr);
        if (rt != chkapi_OK)
            return uicore->errors.put(rt, "Could not write terminating zero from string", "[=getdesign_name=]_writestring0_unknown");
    }
    return chkapi_OK;
}

int [=getdesign_name=]_writestring0_unknown(Checkers_uicore* uicore, const char* val, int sz, int si, int csz, AddressType addr, int term_zero)
{
    for (int i = 0; i < sz; i++) {
        long long cval = val[i];
        int rt = [=getdesign_name=]_write0_unknown(uicore, &cval,1, si, addr);
...
{
    return [=getdesign_name=]_readstring0_unknown(uicore, val, chess_[=getdesign_name=]_DMh_si, 2, addr);
}

int [=getdesign_name=]_writestring_DMh(Checkers_uicore* uicore, std::string val, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, chess_[=getdesign_name=]_DMh_si, 2, addr, term_zero);
}

int [=getdesign_name=]_writestring_DMh(Checkers_uicore* uicore, const char* val, int sz, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, sz,chess_[=getdesign_name=]_DMh_si, 2, addr, term_zero);
}

int [=getdesign_name=]_readstring_DMw(Checkers_uicore* uicore, std::string& val, AddressType addr)
{
    return [=getdesign_name=]_readstring0_unknown(uicore, val, chess_[=getdesign_name=]_DMw_si, 4, addr);
}

int [=getdesign_name=]_writestring_DMw(Checkers_uicore* uicore, std::string val, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, chess_[=getdesign_name=]_DMw_si, 4, addr, term_zero);
}

int [=getdesign_name=]_writestring_DMw(Checkers_uicore* uicore, const char* val, int sz, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, sz,chess_[=getdesign_name=]_DMw_si, 4, addr, term_zero);
}
...
{
    return [=getdesign_name=]_readstring0_unknown(uicore, val, chess_[=getdesign_name=]_DMh_stat_si, 2, addr);
}

int [=getdesign_name=]_writestring_DMh_stat(Checkers_uicore* uicore, std::string val, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, chess_[=getdesign_name=]_DMh_stat_si, 2, addr, term_zero);
}

int [=getdesign_name=]_writestring_DMh_stat(Checkers_uicore* uicore, const char* val, int sz, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, sz,chess_[=getdesign_name=]_DMh_stat_si, 2, addr, term_zero);
}

int [=getdesign_name=]_readstring_DMw_stat(Checkers_uicore* uicore, std::string& val, AddressType addr)
{
    return [=getdesign_name=]_readstring0_unknown(uicore, val, chess_[=getdesign_name=]_DMw_stat_si, 4, addr);
}

int [=getdesign_name=]_writestring_DMw_stat(Checkers_uicore* uicore, std::string val, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, chess_[=getdesign_name=]_DMw_stat_si, 4, addr, term_zero);
}

int [=getdesign_name=]_writestring_DMw_stat(Checkers_uicore* uicore, const char* val, int sz, AddressType addr, int term_zero)
{
    return [=getdesign_name=]_writestring0_unknown(uicore, val, sz,chess_[=getdesign_name=]_DMw_stat_si, 4, addr, term_zero);
}
...
{
    long long val = 0;
    if (addr % 4) addr += 4 - addr % 4;
    int rt = [=getdesign_name=]_read1_record0/*__cnvt_bool*/(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    addr += 4;
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_put_DMb_bool(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    long long val = uval;
    rt = [=getdesign_name=]_write1_record0/*__cnvt_bool*/(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
...
{
    if (addr % 4) addr += 4 - addr % 4;
    int rt = [=getdesign_name=]_read1_record1/*dint*/(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    addr += 8;
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_put_DMb___slonglong(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record1/*dint*/(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_gete_DMb___ffloat(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    val = checkers_expo_to_double(eval, 32, 2, 8, 3, 3, 0, 0, 0, 0);
    return chkapi_OK;
}
...
{
    long long eval;
    int rt = checkers_floating_encoded_value(val, uicore, 32, 2, 0, 8, 3, 3, 0, 0, 0, 0, eval);
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_gete_DMb___fdouble(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    val = checkers_expo_to_double(eval, 64, 2, 11, 3, 3, 0, 0, 0, 0);
    return chkapi_OK;
}
...
{
    long long eval;
    int rt = checkers_floating_encoded_value(val, uicore, 64, 2, 0, 11, 3, 3, 0, 0, 0, 0, eval);
    if (rt != chkapi_OK)
...
// ! no suitable stack memory for type `u08'
...
// ! no suitable stack memory for type `t1u'

// ! no suitable stack memory for type `t1u'

// ! no suitable stack memory for type `t2u'

// ! no suitable stack memory for type `t2u'

// ! no suitable stack memory for type `t5u'

// ! no suitable stack memory for type `t5u'

// ! no suitable stack memory for type `t6u'

// ! no suitable stack memory for type `t6u'

// ! no suitable stack memory for type `t8u'

// ! no suitable stack memory for type `t8u'

// ! no suitable stack memory for type `t12s'

// ! no suitable stack memory for type `t12s'

// ! no suitable stack memory for type `t5unz'

// ! no suitable stack memory for type `t5unz'

// ! no suitable stack memory for type `t13s_s2'

// ! no suitable stack memory for type `t13s_s2'

int [=getdesign_name=]_get_DMb_t20s_rp12(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    if (addr % 4) addr += 4 - addr % 4;
    int rt = [=getdesign_name=]_read0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    addr += 4;
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not get t20s_rp12 value", "[=getdesign_name=]_get_DMb_t20s_rp12");
    return chkapi_OK;
}

int [=getdesign_name=]_put_DMb_t20s_rp12(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    unsigned long long pval = 0;
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_t20s_rp12");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not put t20s_rp12 value", "[=getdesign_name=]_put_DMb_t20s_rp12");
    return chkapi_OK;
}

int [=getdesign_name=]_getalt_DMb_t20s_rp12(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    if (addr % 4) addr += 4 - addr % 4;
    int rt = [=getdesign_name=]_read0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    addr += 4;
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not get t20s_rp12 value", "[=getdesign_name=]_getalt_DMb_t20s_rp12");
    return chkapi_OK;
}

int [=getdesign_name=]_putalt_DMb_t20s_rp12(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    unsigned long long pval = 0;
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_t20s_rp12");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not put t20s_rp12 value", "[=getdesign_name=]_putalt_DMb_t20s_rp12");
    return chkapi_OK;
}

// ! no suitable stack memory for type `t21s_s2'

// ! no suitable stack memory for type `t21s_s2'

// ! no suitable stack memory for type `t31s_rp1'

// ! no suitable stack memory for type `t31s_rp1'

// ! no suitable stack memory for type `w64'

// ! no suitable stack memory for type `w64'

// ! no suitable stack memory for type `v22w32'
...
static Ctp_access_fn acfns[] = {
#ifdef checkers_[=getdesign_name=]_PMb_si
    { checkers_[=getdesign_name=]_PMb_si, "u08", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
...
#ifdef checkers_[=getdesign_name=]_DMb_si
    { checkers_[=getdesign_name=]_DMb_si, "bool", [=getdesign_name=]_read1_record0/*__cnvt_bool*/, [=getdesign_name=]_write1_record0/*__cnvt_bool*/ },
    ...
    { checkers_[=getdesign_name=]_DMb_si, "__slonglong", [=getdesign_name=]_read1_record1/*dint*/, [=getdesign_name=]_write1_record1/*dint*/ },
    { checkers_[=getdesign_name=]_DMb_si, "__ulonglong", [=getdesign_name=]_read1_record1/*dint*/, [=getdesign_name=]_write1_record1/*dint*/ },
    { checkers_[=getdesign_name=]_DMb_si, "__ffloat", [=getdesign_name=]_read0_DMw, [=getdesign_name=]_write0_DMw },
    { checkers_[=getdesign_name=]_DMb_si, "__fdouble", [=getdesign_name=]_read1_record1/*dint*/, [=getdesign_name=]_write1_record1/*dint*/ },
    { checkers_[=getdesign_name=]_DMb_si, "__flongdouble", [=getdesign_name=]_read1_record1/*dint*/, [=getdesign_name=]_write1_record1/*dint*/ },
    ...
    { checkers_[=getdesign_name=]_DMb_si, "t20s_rp12", [=getdesign_name=]_read0_pad12_DMw, [=getdesign_name=]_write0_pad12_DMw },
#endif //checkers_[=getdesign_name=]_DMb_si
#ifdef checkers_[=getdesign_name=]_DMh_si
    { checkers_[=getdesign_name=]_DMh_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMh_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    ...
    { checkers_[=getdesign_name=]_DMh_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMh_si, "w16", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_DMh_si
#ifdef checkers_[=getdesign_name=]_DMw_si
    { checkers_[=getdesign_name=]_DMw_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_DMw_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    ...
    { checkers_[=getdesign_name=]_DMw_si, "__slonglong", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    { checkers_[=getdesign_name=]_DMw_si, "__ulonglong", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    { checkers_[=getdesign_name=]_DMw_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_si, "__fdouble", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    { checkers_[=getdesign_name=]_DMw_si, "__flongdouble", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    ...
    { checkers_[=getdesign_name=]_DMw_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_DMw_si
#ifdef checkers_[=getdesign_name=]_DMb_stat_si
    { checkers_[=getdesign_name=]_DMb_stat_si, "bool", [=getdesign_name=]_read1_record4/*__cnvt_bool*/, [=getdesign_name=]_write1_record4/*__cnvt_bool*/ },
    ...
    { checkers_[=getdesign_name=]_DMb_stat_si, "__slonglong", [=getdesign_name=]_read1_record5/*dint*/, [=getdesign_name=]_write1_record5/*dint*/ },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__ulonglong", [=getdesign_name=]_read1_record5/*dint*/, [=getdesign_name=]_write1_record5/*dint*/ },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__ffloat", [=getdesign_name=]_read0_DMw_stat, [=getdesign_name=]_write0_DMw_stat },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__fdouble", [=getdesign_name=]_read1_record5/*dint*/, [=getdesign_name=]_write1_record5/*dint*/ },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__flongdouble", [=getdesign_name=]_read1_record5/*dint*/, [=getdesign_name=]_write1_record5/*dint*/ },
    ...
    { checkers_[=getdesign_name=]_DMb_stat_si, "t20s_rp12", [=getdesign_name=]_read0_pad12_DMw_stat, [=getdesign_name=]_write0_pad12_DMw_stat },
#endif //checkers_[=getdesign_name=]_DMb_stat_si
#ifdef checkers_[=getdesign_name=]_DMh_stat_si
    { checkers_[=getdesign_name=]_DMh_stat_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMh_stat_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    ...
    { checkers_[=getdesign_name=]_DMh_stat_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
...
#ifdef checkers_[=getdesign_name=]_DMw_stat_si
    { checkers_[=getdesign_name=]_DMw_stat_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    ...
    { checkers_[=getdesign_name=]_DMw_stat_si, "__slonglong", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__ulonglong", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__fdouble", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__flongdouble", [=getdesign_name=]_read1_record3/*dint*/, [=getdesign_name=]_write1_record3/*dint*/ },
    ...
    { checkers_[=getdesign_name=]_DMw_stat_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_stat_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_DMw_stat_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
...
#ifdef checkers_[=getdesign_name=]_PC_ID_si
    { checkers_[=getdesign_name=]_PC_ID_si, "addr", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_PC_ID_si
#ifdef checkers_[=getdesign_name=]_PC_EX_si
    { checkers_[=getdesign_name=]_PC_EX_si, "addr", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_PC_EX_si
#ifdef checkers_[=getdesign_name=]_X_si
    { checkers_[=getdesign_name=]_X_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X_si
#ifdef checkers_[=getdesign_name=]_LR_si
    { checkers_[=getdesign_name=]_LR_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_LR_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_LR_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_LR_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LR_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    ...
    { checkers_[=getdesign_name=]_LR_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_LR_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_LR_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LR_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_LR_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    ...
    { checkers_[=getdesign_name=]_LR_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_LR_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_LR_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LR_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_LR_si
#ifdef checkers_[=getdesign_name=]_SP_si
    { checkers_[=getdesign_name=]_SP_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_SP_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_SP_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_SP_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_SP_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    ...
    { checkers_[=getdesign_name=]_SP_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_SP_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_SP_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_SP_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_SP_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    ...
    { checkers_[=getdesign_name=]_SP_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_SP_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_SP_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_SP_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
...
#ifdef checkers_[=getdesign_name=]_X10_si
    { checkers_[=getdesign_name=]_X10_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X10_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X10_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X10_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X10_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X10_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X10_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X10_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X10_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X10_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X10_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X10_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X10_si
#ifdef checkers_[=getdesign_name=]_X11_si
    { checkers_[=getdesign_name=]_X11_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X11_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X11_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X11_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X11_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X11_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X11_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X11_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X11_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X11_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X11_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X11_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X11_si
#ifdef checkers_[=getdesign_name=]_X12_si
    { checkers_[=getdesign_name=]_X12_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X12_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X12_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X12_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X12_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X12_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X12_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X12_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X12_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X12_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X12_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X12_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X12_si
#ifdef checkers_[=getdesign_name=]_X13_si
    { checkers_[=getdesign_name=]_X13_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X13_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X13_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X13_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X13_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X13_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X13_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X13_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X13_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X13_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X13_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X13_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X13_si
#ifdef checkers_[=getdesign_name=]_X14_si
    { checkers_[=getdesign_name=]_X14_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X14_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X14_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X14_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X14_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X14_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X14_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X14_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X14_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X14_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X14_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X14_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X14_si
#ifdef checkers_[=getdesign_name=]_X15_si
    { checkers_[=getdesign_name=]_X15_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X15_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X15_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X15_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X15_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X15_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X15_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X15_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X15_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X15_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X15_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X15_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X15_si
#ifdef checkers_[=getdesign_name=]_X16_si
    { checkers_[=getdesign_name=]_X16_si, "bool", [=getdesign_name=]_read1_record2/*__cnvt_bool*/, [=getdesign_name=]_write1_record2/*__cnvt_bool*/ },
    { checkers_[=getdesign_name=]_X16_si, "__cchar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X16_si, "__schar", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X16_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__sshort", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X16_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__slonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X16_si, "__ulonglong", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X16_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__fdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X16_si, "__flongdouble", [=getdesign_name=]_read1_record6/*dint*/, [=getdesign_name=]_write1_record6/*dint*/ },
    { checkers_[=getdesign_name=]_X16_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "w08", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X16_si, "w16", [=getdesign_name=]_read0_unknown, [=getdesign_name=]_write0_unknown },
    { checkers_[=getdesign_name=]_X16_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_X16_si, "t20s_rp12", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
#endif //checkers_[=getdesign_name=]_X16_si
    { -1, 0, 0, 0 } /* sentinel */
};
...
int [=getdesign_name=]_chess_assert_bool(Checkers_uicore* uicore, int& oval)
{
    ...
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read1_record2/*__cnvt_bool*/(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_assert___cchar(Checkers_uicore* uicore, int& oval)
{
    ...
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0_unknown(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_assert___uchar(Checkers_uicore* uicore, int& oval)
{
    ...
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_assert___slonglong(Checkers_uicore* uicore, int& oval)
{
    ...
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(11));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_assert_w08(Checkers_uicore* uicore, int& oval)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0_unknown(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert_w08");
    val[0] |= CHESS_MASKLL(fval[0], 8) << 0;
    val[0] = CHESS_EXTENDLL(val[0],8);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert_w16(Checkers_uicore* uicore, int& oval)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0_unknown(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert_w16");
    val[0] |= CHESS_MASKLL(fval[0], 16) << 0;
    val[0] = CHESS_EXTENDLL(val[0],16);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
static Chess_assert_fn cafns[] = {
    ...
    { "w08", [=getdesign_name=]_chess_assert_w08 },
    { "w16", [=getdesign_name=]_chess_assert_w16 },
...
int [=getdesign_name=]_chess_report_w08(Checkers_uicore* uicore, std::ostream& os)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0_unknown(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report_w08");
    val[0] |= CHESS_MASKLL(fval[0], 8) << 0;
    val[0] = CHESS_EXTENDLL(val[0],8);
...
int [=getdesign_name=]_chess_report_w16(Checkers_uicore* uicore, std::ostream& os)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0_unknown(uicore, fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report_w16");
    val[0] |= CHESS_MASKLL(fval[0], 16) << 0;
    val[0] = CHESS_EXTENDLL(val[0],16);
...
static Chess_report_fn crfns[] = {
    ...
    { "w08", [=getdesign_name=]_chess_report_w08 },
    { "w16", [=getdesign_name=]_chess_report_w16 },
...
int [=getdesign_name=]_chess_return_value___cchar(Checkers_uicore* uicore, DataType& ovbit)
{
    DataType vbit(8, 1, 0);
    int rt = chkapi_OK;
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_X_si, AddressType(101), at_addr), vbit);
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_return_value___slonglong(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_X_si, AddressType(101), at_addr), vbit_component0);
    if (rt != chkapi_OK)
    ...
    vbit.deposit(vbit_component0, 31, 0);
    // component 1 : 32 bits at 32
    DataType vbit_component1(32, 0, 0);
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_X_si, AddressType(111), at_addr), vbit_component1);
    if (rt != chkapi_OK)
    ...
    vbit.deposit(vbit_component1, 63, 32);
    /* complete */
    ovbit = vbit;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value_w08(Checkers_uicore* uicore, DataType& ovbit)
{
    DataType vbit(8, 1, 0);
    int rt = chkapi_OK;
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_X_si, AddressType(101), at_addr), vbit);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value_w08");
    ovbit = vbit;
    return chkapi_OK;
}

int [=getdesign_name=]_chess_return_value_w16(Checkers_uicore* uicore, DataType& ovbit)
{
    DataType vbit(16, 1, 0);
    int rt = chkapi_OK;
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_X_si, AddressType(101), at_addr), vbit);
    if (rt != chkapi_OK)
        return uicore->errors.put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value_w16");
    ovbit = vbit;
    return chkapi_OK;
}
...
static Chess_return_value_fn cvfns[] = {
    ...
    { "w08", [=getdesign_name=]_chess_return_value_w08 },
    { "w16", [=getdesign_name=]_chess_return_value_w16 },
...
int [=getdesign_name=]_chess_cycle_count(Checkers_uicore* uicore, long long val)
{
    ...
    rt = [=getdesign_name=]_write0(uicore, &fval,1, chess_[=getdesign_name=]_X_si, AddressType(10));
    if (rt != chkapi_OK)
    ...
    rt = [=getdesign_name=]_write0(uicore, &fval,1, chess_[=getdesign_name=]_X_si, AddressType(11));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_write_main_argc_argv(Checkers_uicore* uicore, long long argc, AddressType argv)
{
    ...
    val = argv;
    fval = CHESS_MASKLL(val >> 0,32);
    rt = [=getdesign_name=]_write0(uicore, &fval,1, chess_[=getdesign_name=]_X_si, AddressType(12));
    if (rt != chkapi_OK)
...
#if 0
#define _CHECK_HCT_MEMB(N,O) _Static_assert(offsetof(Hosted_clib_vars, N) == O, "incorrect offset of " #N);
_CHECK_HCT_MEMB(call_type, 0)
_CHECK_HCT_MEMB(stream_id, 4)
_CHECK_HCT_MEMB(stream_rt, 8)
_CHECK_HCT_MEMB(str_arg1, 12)
_CHECK_HCT_MEMB(str_arg2, 16)
_CHECK_HCT_MEMB(format, 20)
_CHECK_HCT_MEMB(offset, 24)
_CHECK_HCT_MEMB(int_arg1, 28)
_CHECK_HCT_MEMB(eof, 32)
_CHECK_HCT_MEMB(int_arg2, 36)
_CHECK_HCT_MEMB(puts_s, 40)
_CHECK_HCT_MEMB(gets_s, 44)
_CHECK_HCT_MEMB(size, 48)
_CHECK_HCT_MEMB(nmemb, 52)
_CHECK_HCT_MEMB(write_ptr, 56)
_CHECK_HCT_MEMB(read_ptr, 60)
_CHECK_HCT_MEMB(ap, 64)
#endif
