...
#ifndef _trv32p3_chess_llvm_h
#define _trv32p3_chess_llvm_h
...
#ifdef __cplusplus
#if 0//not yet
    inline __attribute__((always_inline)) trv32p3_primitive::dint::dint(unsigned l, unsigned h) __attribute__((overloadable))
    : low(l), high(h)
    {
    }
#endif
