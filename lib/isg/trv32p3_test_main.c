...
using namespace trv32p3_primitive;
...
bool operator!=(trv32p3_primitive::addr x1, trv32p3_primitive::addr x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::iword x1, trv32p3_primitive::iword x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t12s x1, trv32p3_primitive::t12s x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t13s_s2 x1, trv32p3_primitive::t13s_s2 x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t1u x1, trv32p3_primitive::t1u x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t20s_rp12 x1, trv32p3_primitive::t20s_rp12 x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t21s_s2 x1, trv32p3_primitive::t21s_s2 x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t2u x1, trv32p3_primitive::t2u x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t31s_rp1 x1, trv32p3_primitive::t31s_rp1 x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t5u x1, trv32p3_primitive::t5u x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::t5unz x1, trv32p3_primitive::t5unz x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::u08 x1, trv32p3_primitive::u08 x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::w08 x1, trv32p3_primitive::w08 x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::w16 x1, trv32p3_primitive::w16 x2) {
    return toVBit(x1) != toVBit(x2);
}

bool operator!=(trv32p3_primitive::w32 x1, trv32p3_primitive::w32 x2) {
    return toVBit(x1) != toVBit(x2);
}

void test_w32_add_w32_w32(std::istream& is) {
    trv32p3_primitive::w32 result_expected;
    trv32p3_primitive::w32 t0;
    trv32p3_primitive::w32 t1;
    read_from_stream(is, t0);
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = add(t0, t1);
...
void test_w32_sub_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = sub(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_slt_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = slt(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_sltu_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = sltu(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_seq0_w32(std::istream& is) {
    ...
    read_from_stream(is, t0);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = seq0(t0);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_sne0_w32(std::istream& is) {
    ...
    read_from_stream(is, t0);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = sne0(t0);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_mul_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = mul(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_mulh_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = mulh(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_mulhsu_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = mulhsu(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_mulhu_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = mulhu(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_band_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = band(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_bor_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = bor(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_bxor_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = bxor(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_sra_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = sra(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_sll_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = sll(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_srl_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = srl(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}

void test_w32_sext_w08(std::istream& is) {
    trv32p3_primitive::w32 result_expected;
    trv32p3_primitive::w08 t0;
    read_from_stream(is, t0);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = sext(t0);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_zext_w08(std::istream& is) {
    ...
    read_from_stream(is, t0);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = zext(t0);
    if (result != result_expected) { failure(result_expected, result); return; }
}

void test_w32_sext_w16(std::istream& is) {
    trv32p3_primitive::w32 result_expected;
    trv32p3_primitive::w16 t0;
    read_from_stream(is, t0);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = sext(t0);
    if (result != result_expected) { failure(result_expected, result); return; }
...
void test_void_mul_hw_w32_w32_t2u_w32_w32(std::istream& is) {
    trv32p3_primitive::w32 t0;
    trv32p3_primitive::w32 t1;
    trv32p3_primitive::t2u t2;
    trv32p3_primitive::w32 t3;
    trv32p3_primitive::w32 t3_expected;
    trv32p3_primitive::w32 t4;
    trv32p3_primitive::w32 t4_expected;
    read_from_stream(is, t0);
    read_from_stream(is, t1);
...
void test_w32_divs_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = divs(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_rems_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = rems(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_divu_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = divu(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_remu_w32_w32(std::istream& is) {
    ...
    read_from_stream(is, t1);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = remu(t0, t1);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
void test_w32_mac_w32_w32_w32(std::istream& is) {
    ...
    trv32p3_primitive::w32 t0;
    trv32p3_primitive::w32 t1;
    trv32p3_primitive::w32 t2;
    read_from_stream(is, t0);
    read_from_stream(is, t1);
    read_from_stream(is, t2);
    read_from_stream(is, result_expected);
    trv32p3_primitive::w32 result = mac(t0, t1, t2);
    if (result != result_expected) { failure(result_expected, result); return; }
}
...
int main() {
    ...
    error_stream = new std::ofstream("trv32p3_c_failures.txt");
    std::ifstream in_stream("trv32p3_testcases.txt");
