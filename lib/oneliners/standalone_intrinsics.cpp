...
int intrc___sint_exp___sint(int a0)
    { return exp(a0); }

int intrc___sint_ReLU___sint(int a0)
    { return ReLU(a0); }

int intrc___sint_incmac___sint___sint___sint___sint___sint___sint___sint(int a0, int a1, int a2, int a3, int & a4, int a5, int & a6)
    { return incmac(a0, a1, a2, a3, a4, a5, a6); }


} //extern "C"  (60 functions of which 5 skipped)
