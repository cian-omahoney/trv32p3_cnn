...
#ifndef INCLUDE_TRV32P3_CNN_IAPCU_H_
#define INCLUDE_TRV32P3_CNN_IAPCU_H_
...
inline void trv32p3_cnn_user_next_pc(trv32p3_cnn* mdl, AddressType next_pc, unsigned nw, Checkers_next_pc_type npt)
{
  /* User code here */
...
#endif // INCLUDE_TRV32P3_CNN_IAPCU_H_
